...
- <a href="#get-an-asset-balance-of-an-address">
    Get an asset balance of an address
  </a>
- <a href="#list-all-asset-balances-of-an-address">
    List all asset balances of an address
  </a>
- <a href="#list-all-transactions-from-an-address">
    List all transactions from an address
  </a>
- <a href="#list-the-latest-transactions">List the latest transactions</a>
- <a href="#get-an-asset-balance-of-a-contract">
    Get an asset balance of a contract
  </a>
- <a href="#list-all-asset-balances-of-a-contract">
...
- <a href="#list-all-messages-owned-by-address">
